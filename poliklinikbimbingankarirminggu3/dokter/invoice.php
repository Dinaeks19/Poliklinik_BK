...
if ($ambil_dokter) {
    ...
    if ($row_dokter) {
        ...
        // Tangani kasus ketika tidak ada baris yang diambil
        $nama_dokter = "Data tidak ditemukan";
        $alamat_dokter = "";
        $hp_dokter = "";
    }
} else {
    // Tangani kasus ketika kueri gagal
    $nama_dokter = "Kueri gagal";
    $alamat_dokter = "";
    $hp_dokter = "";
}

// Sekarang Anda dapat menggunakan $nama_dokter, $alamat_dokter, dan $hp_dokter tanpa memicu peringatan
